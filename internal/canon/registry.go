...
func commandRegistry() []CommandInfo {
	return []CommandInfo{
		...
		{
			Name:        "validate",
			Purpose:     "Run the full corpus integrity check catalog: malformed files, duplicate ids, broken references, reciprocity, status and date validity, and kind/id/directory coherence. Never mutates; exit 4 on errors, or on warnings with --strict.",
			Safety:      "read-only",
